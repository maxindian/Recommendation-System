...
total_number= {}
file_object = open('Orignial_R.txt','w')
...
#       (eval_iters,val_rmse))
V = autoencoder_aaai.autoencoder1(NT,V_side,n_feature=128,batch_size=128,n_input=6040,n_input1=19,num_examples=3952,training_epochs=50,learning_rate=0.004)
U = autoencoder_aaai.autoencoder(N,U_side,n_feature=128,batch_size=128,n_input=3952,n_input1=29,num_examples=6040,training_epochs=50,learning_rate=0.004)
for i in range(10):
	print(i)
	val_rmse=0.0
	if i<=0:
