...
class BPMF(ModelBase):
    ...
    def __init__(self, n_user, n_item, n_feature, U,V,beta=2.0, beta_user=2.0,
    ...
    def R_predict(self):
        R_predict = np.dot(self.user_features_,self.item_features_.T)
